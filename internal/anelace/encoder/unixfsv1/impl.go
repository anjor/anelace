...
import (
	...
	"github.com/anjor/anelace/internal/anelace/util/encoding"
	"github.com/anjor/anelace/internal/zcpstring"
)
...
func (e *encoder) NewLeaf(ds anlblock.DataSource) *anlblock.Header {
...
func (e *encoder) NewLink(blocks []*anlblock.Header) *anlblock.Header {

	// special-case compat bullshit
	if blocks == nil {
		h := e.compatNulBlock()
		e.NewLinkBlockCallback(h)
		return h
	}
...
func (e *encoder) compatNulBlock() *anlblock.Header {
	return e.BlockMaker(
		nulPb,
		anlblock.CodecPB,
		0,
